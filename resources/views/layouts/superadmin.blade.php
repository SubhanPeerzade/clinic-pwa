...
<head>
    <meta charset="utf-8">
    <title>Super Admin | Clinic PWA</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="sidebar" class="col-md-3 col-lg-2 sidebar">
                <h5><i class="bi bi-shield-lock-fill"></i> Clinic Admin</h5>
                ...
                <a href="{{ route('admin.reception.index') }}"
                    class="{{ request()->routeIs('admin.reception.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('reports.daily') }}"
                    ...
                    <i class="bi bi-file-earmark-medical-fill"></i> Reports
                </a>
